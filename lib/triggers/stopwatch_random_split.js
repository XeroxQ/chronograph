...
class StopwatchRandomSplit extends Homey.FlowCardTrigger {
	constructor(triggerId) {
		...
		this.registerRunListener((args, state) => {
			...
			return Promise.resolve(id == state.stopwatchId && args.seconds == state.duration);
		});
...
module.exports = StopwatchRandomSplit;
